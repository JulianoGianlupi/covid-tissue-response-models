...
<!-- generated with COPASI 4.30 (Build 240) (http://www.copasi.org) at 2021-09-02T22:02:37Z -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <Model key="Model_0" name="New Model" simulationType="time" timeUnit="h" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_0">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:chebi:"/>
  </rdf:Description>
</rdf:RDF>

        </MiriamAnnotation>
        <Comment>
          An organic triphosphate that is GS-441524 in which the 5'-hydroxy group has been replaced by a triphosphate group. It is the active metabolite of remdesivir.


https://pubchem.ncbi.nlm.nih.gov/compound/GS-443902
CAS 1355149-45-9

ChEBI:150869
http://purl.obolibrary.org/obo/CHEBI_150869
        </Comment>
      </Metabolite>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5472" name="k" value="1"/>
          <Constant key="Parameter_5158" name="dose" value="0.000331903"/>
          <Constant key="Parameter_5471" name="duration" value="2"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5473" name="k1" value="0.0231049"/>
        </ListOfConstants>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-09-02T22:01:33Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[Body]" value="38.399999999999999" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[Body],Vector=Metabolites[GS443902_source]" value="7.6752726638996981e+21" type="Species" simulationType="reactions">
            <InitialExpression>
              &lt;CN=Root,Model=New Model,Vector=Values[Remdes_dose_mol],Reference=InitialValue>
            </InitialExpression>
          </ModelParameter>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[k_out]" value="0.023104906018664842" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              log(2)/&lt;CN=Root,Model=New Model,Vector=Values[Observed_t1_2],Reference=InitialValue>
            </InitialExpression>
          </ModelParameter>
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Observed_t1_2]" value="30" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Clearance]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Clearance],ParameterGroup=Parameters,Parameter=k1" value="0.023104906018664842" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 0 7.6752726638996981e+21 0 38.399999999999999 1 0.023104906018664842 602.58500000000004 0 0 0 200 0.00033190338292523046 2 30 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="StepNumber" type="unsignedInteger" value="8029"/>
        <Parameter name="StepSize" type="float" value="0.024785153819999999"/>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-09-02T22:01:02Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
