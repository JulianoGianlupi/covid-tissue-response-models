...
<!-- generated with COPASI 4.30 (Build 240) (http://www.copasi.org) at 2021-09-02T22:02:48Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_0">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:chebi:CHEBI:150869"/>
  </rdf:Description>
</rdf:RDF>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_5158" name="dose" value="0.000124464"/>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5473" name="k1" value="0.022791"/>
        </ListOfConstants>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-09-02T21:53:20Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
    ...
    <InitialState type="initialState">
      0 0 0 3.7439998654613522e+21 0 49.950744815422574 1 0.022790987164696842 602.58500000000004 0 0 0 75 0.00012446376859696142 2 30.413214467235882 0 50 150 0 0 0 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_8" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
      <Report reference="Report_6" target="Param_est_results.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
        <Parameter name="Randomize Start Values" type="bool" value="0"/>
        <Parameter name="Calculate Statistics" type="bool" value="1"/>
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="70"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="40"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-09-02T21:52:03Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
